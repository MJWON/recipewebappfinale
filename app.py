...
# 성별, 나이별 추천 키워드 
male_keywords = ["스테이크", "삼겹살", "치킨", "갈비", "돈까스", "피자", "햄버거", "라면", "카레", "치즈","감자탕", "떡볶이", "파스타", "짬뽕", "마라탕", "부대찌개", "감자", "계란찜", "된장찌개", "순두부찌개","돈불고기", "족발", "닭볶음탕", "회", "참치", "해물파전", "불닭", "김치찌개", "김밥", "토마토파스타"]
female_keywords = ["샐러드", "오트밀", "닭가슴살", "과일", "두부", "콩나물국", "잡곡밥", "도라지무침", "과일주스", "현미밥","오믈렛", "연어샐러드", "닭가슴살샐러드", "아보카도", "청포묵무침", "연두부", "구운야채", "토마토", "버섯볶음", "가지구이","미역국", "단호박죽", "오트밀죽", "방울토마토", "시금치나물", "고구마구이", "코코넛워터", "아몬드", "야채수프", "로제파스타"]
age_keywords = {"20": ["샐러드", "떡볶이", "치즈볼", "치킨", "김밥", "마라탕", "파스타", "아보카도", "로제파스타", "라면","샤브샤브", "버블티", "닭갈비", "오므라이스", "스시", "유부초밥", "쌀국수", "팬케이크", "베이글", "초밥","회덮밥", "함박스테이크", "치즈돈까스", "케밥", "계란토스트", "콩나물불고기", "망고빙수", "불닭볶음면", "버거", "타코"],
                "30": ["잡채", "된장찌개", "갈비찜", "콩나물국", "파프리카볶음", "유산슬", "닭볶음탕", "돼지불고기", "새우볶음밥", "순두부찌개","연어스테이크", "양송이수프", "스테이크", "쭈꾸미볶음", "굴전", "낙지볶음", "현미밥", "스파게티", "연두부샐러드", "깻잎김치","두부구이", "오징어볶음", "닭죽", "우엉조림", "치즈스틱", "크림파스타", "쌀국수", "피클", "불고기", "양배추롤"],
                "40": ["도라지무침", "고등어조림", "시금치나물", "북엇국", "청국장", "미역국", "배추전", "소고기무국", "우거지탕", "버섯볶음","멸치볶음", "김치전", "계란찜", "연근조림", "꽁치구이", "청포묵무침", "깻잎장아찌", "가자미조림", "양배추쌈", "삼치구이","가지무침", "쑥갓나물", "돼지수육", "카레라이스", "삼계탕", "닭도리탕", "현미밥", "잡곡밥", "고사리나물", "애호박전"],
                "50": ["연근조림", "나물비빔밥", "매생이국", "순두부찌개", "장어구이", "도미구이", "갓김치", "닭한마리", "묵은지찜", "닭백숙","굴국밥", "홍합미역국", "곤드레밥", "생선전", "애호박볶음", "우엉조림", "우거지국", "코다리찜", "동태찌개", "청국장","보리밥", "시래기국", "갈치조림", "보쌈", "매운탕", "돌나물무침", "우럭조림", "브로콜리무침", "고사리나물", "쑥국"],
                "60": ["미역줄기볶음", "우엉조림", "고들빼기", "청포묵무침", "연근조림", "더덕구이", "곤드레밥", "닭죽", "명란젓", "보리굴비","전복죽", "조개탕", "김치찌개", "매운탕", "콩비지찌개", "청국장", "연근나물", "모듬전", "갓김치", "호박죽","모시조개국", "무나물", "코다리조림", "쑥국", "가지나물", "콩나물국", "누룽지", "고구마줄기볶음", "무국", "청경채나물"]}
...
with st.form("recipe_form"):
    region = st.selectbox("거주 지역(나라 이름) 선택",("한국", "중국", "일본", "미국", "이탈리아", "프랑스", "동남아", "태국", "베트남", "인도", "그리스", "멕시코", "스페인", "터키", "러시아", "영국", "독일", "브라질", "세계요리"))
...
if submitted:
    ...
    if len(ingredients) < 3:
        ...
        for item in recipes:
            ...
            results.append({"title": title,"link": link,"match_rate": match_rate,"matched": matched,"unmatched": unmatched})
